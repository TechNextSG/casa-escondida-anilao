...
(function () {
  ...
  const translations = {
    en: {
      ...
      bn_sub: 'Tell us about your trip and we\'ll send you a personalised quotation — rooms, meals, transfers and diving in one request.',
      bn_hero_cta: 'Start your request',
      bn_hero_cta_ghost: 'Talk to us',
      bn_steps_eyebrow: 'How it works',
      bn_steps_h2: 'Three simple <em>steps</em>',
      bn_step1_t: 'Tell us about your trip',
      bn_step1_d: 'Dates, group size, rooms, meals, transfers and diving — all in one form.',
      bn_step2_t: 'We check availability',
      bn_step2_d: 'Our team reviews your request and replies by email with a quotation.',
      bn_step3_t: 'Confirm your booking',
      bn_step3_d: 'Happy with the quote? Confirm with us and start packing.',
      bn_sec_eyebrow: 'Request a quotation',
      bn_sec_h2: 'Plan your <em>stay</em>',
      bn_sec_sub: 'Guests, travel agents and dive instructors — choose who you are and we\'ll ask only what we need.',
      bn_aside_h: 'Prefer to <em>talk?</em>',
      bn_aside_p: 'Our front desk is open until 9 PM. Message us on Facebook or call for the quickest reply.',
      bn_cm_phone: 'Phone / Viber',
      bn_cm_email: 'Email',
      bn_incl_h: 'What your quotation <em>covers</em>',
      bn_incl_1: 'Rooms & nightly rates',
      bn_incl_2: 'Meal plan (full board or room only)',
      bn_incl_3: 'Airport van transfer',
      bn_incl_4: 'Diving, courses & certifications',
      bn_know_h: 'Good to <em>know</em>',
      bn_know_1: 'Exact dates aren\'t needed yet — a tentative month is enough.',
      bn_know_2: 'Check-in from 2:00 PM · front desk open until 9 PM.',
      bn_know_3: 'Travel agents and dive instructors: select your role to upload credentials.',
      cf_head: 'Your <em style="color:var(--accent);font-style:italic">Inquiry Form</em>',
      cf_sub: 'Tell us about your trip and we\'ll reply with availability and a quotation. We typically reply within a few hours.',
      cf_who: 'Who\'s asking?',
      cf_pill_guest: 'Guest',
      cf_pill_agent: 'Travel Agent',
      cf_pill_instructor: 'Dive Instructor',
      cf_name: 'Full name',
      cf_name_ph: 'Your full name',
      cf_email: 'Email',
      cf_phone: 'Phone',
      cf_tab_trip: 'Your Trip',
      cf_tab_meal: 'Meal Plan',
      cf_tab_transfer: 'Airport Transfer',
      cf_tab_diving: 'Diving',
      cf_trip_t: 'Your trip',
      cf_trip_sub: 'The basics — when you\'re coming, how many of you, and what rooms you\'ll need.',
      cf_nights: 'Nights staying',
      cf_nights_ph: 'e.g. 4',
      cf_month: 'Tentative month of travel',
      cf_checkin: 'Preferred check-in date',
      cf_optional: '(optional)',
      cf_dates_note: 'Exact dates aren\'t needed yet — we\'ll confirm them when finalizing your booking.',
      cf_same: 'Will everyone in your group have the same length of stay?',
      cf_yes: 'Yes',
      cf_no: 'No',
      cf_total: 'Total number of guests in your group',
      cf_total_ph: 'e.g. 6',
      cf_rooms: 'Rooms',
      cf_room_type: 'Room type',
      cf_room_select: 'Select room type',
      cf_room_std: 'Standard Room',
      cf_room_dlx: 'Deluxe Room',
      cf_room_suite: 'Suite',
      cf_room_pax: 'Pax in this room',
      cf_room_guests: 'Guests',
      cf_room_add: 'Add another room',
      cf_meal: 'Meal plan',
      cf_meal_full: 'Room + Full Board',
      cf_meal_room: 'Room Only',
      cf_meal_hint: 'Full board adds PHP 1,500 per person, per night, and isn\'t included in the base room rate — switch to Room Only if you\'d prefer to dine elsewhere.',
      cf_transfer: 'Would you like us to arrange airport van transfer?',
      cf_transfer_hint: 'PHP 14,000 per van, round trip · max 7 pax with light luggage',
      cf_divers: 'How many of your guests will be diving?',
      cf_divers_ph: '0 if nobody is diving',
      cf_courses: 'Would any of your guests like to take a course or certification during their stay?',
      cf_extra_intro: 'For instructor/agent, kindly upload the following:',
      cf_credentials: 'Credentials',
      cf_cred_hint_instr: 'e.g. your PADI/SSI instructor eCard',
      cf_cred_hint_agent: 'e.g. company / business registration',
      cf_permit: 'Business Permit',
      cf_agency_dive: 'Diving Agency',
      cf_country: 'Country',
      cf_country_ph: 'Country of residence',
      cf_contact_person: 'Contact Person',
      cf_contact_person_ph: 'Who we should ask for',
      cf_agent_name: 'Agent\'s Name',
      cf_agent_name_ph: 'Booking agent\'s name',
      cf_agency: 'Agency',
      cf_agency_ph: 'Agency / company name',
      cf_agency_addr: 'Diving Agency Address',
      cf_agency_addr_ph: 'Agency address',
      cf_message: 'Special requests',
      cf_message_ph: 'Dietary needs, celebrations, accessibility, flight times, or anything else we should know.',
      cf_submit_bn: 'Send Inquiry Form',
      cf_error: 'Something went wrong. Please try again or email us directly.',
      cf_success: 'Thank you! Your inquiry form has been sent. We\'ll reply by email with availability and a quotation.',
      ...
      dive_course1_desc:     'No certification needed. Experience scuba with a pool session followed by a shore dive — gear and Divepro service included.',
      dive_course1_detail1:  'No experience required',
      dive_course1_detail2:  'Half-day experience',
      dive_course1_detail3:  'Max 12m depth',
      dive_course2_level:    'Certification',
      dive_course2_name:     'PADI Open Water Diver',
      dive_course2_desc:     "The world's most popular dive certification. Complete 5 confined water sessions and four open-water dives to earn your lifetime certification, recognized worldwide.",
      ...
      dive_course6_detail1:  'Rescue Diver and Emergency First Responder (EFR) certifications required',
      ...
      dive_pkgs_sub:         'From single guided dives to multi-day stay-and-dive packages — we have options for every diver and every schedule.',
      ...
      dive_pkg2_name:        'Afternoon Dive',
      dive_pkg2_tagline:     'Additional third dive, same day',
      dive_pkg2_feat1:       'Boat fee included',
      dive_pkg2_feat2:       'Service of 1 Divemaster',
      dive_pkg2_feat3:       'Tank & dive permit per dive',
      dive_pkg2_feat4:       'Dive briefing & logbook signing',
      dive_pkg2_feat5:       'Gear rental not included (available separately)',
      ...
      dive_course7_name:     'PADI Refresher',
    ...
    zh: {
      ...
      bn_eyebrow: '预订',
      bn_h1: '立即<em>预订</em>',
      bn_sub: '告诉我们您的行程，我们将为您提供个性化报价——客房、餐饮、接送与潜水，一次搞定。',
      bn_hero_cta: '开始预订',
      bn_hero_cta_ghost: '联系我们',
      bn_steps_eyebrow: '预订流程',
      bn_steps_h2: '简单<em>三步</em>',
      bn_step1_t: '告诉我们您的行程',
      bn_step1_d: '日期、人数、客房、餐饮、接送与潜水——一张表单全部搞定。',
      bn_step2_t: '我们确认空房',
      bn_step2_d: '我们的团队会审核您的请求，并通过电子邮件回复报价。',
      bn_step3_t: '确认预订',
      bn_step3_d: '对报价满意？与我们确认后即可开始收拾行囊。',
      bn_sec_eyebrow: '索取报价',
      bn_sec_h2: '规划您的<em>住宿</em>',
      bn_sec_sub: '无论您是宾客、旅行社还是潜水教练——选择您的身份，我们只会询问必要的信息。',
      bn_aside_h: '想直接<em>联系？</em>',
      bn_aside_p: '前台营业至晚上9点。通过Facebook留言或致电可最快获得回复。',
      bn_cm_phone: '电话 / Viber',
      bn_cm_email: '电子邮件',
      bn_incl_h: '报价<em>包含内容</em>',
      bn_incl_1: '客房与每晚房价',
      bn_incl_2: '餐饮方案（全餐或仅住宿）',
      bn_incl_3: '机场接送车',
      bn_incl_4: '潜水、课程与认证',
      bn_know_h: '温馨<em>提示</em>',
      bn_know_1: '暂时无需确切日期——大致月份即可。',
      bn_know_2: '下午2:00起办理入住 · 前台营业至晚上9点。',
      bn_know_3: '旅行社与潜水教练：请选择您的身份以上传资质文件。',
      cf_head: '您的<em style="color:var(--accent);font-style:italic">咨询表</em>',
      cf_sub: '告诉我们您的行程——我们将回复空房情况与报价。通常几小时内回复。',
      cf_who: '您的身份？',
      cf_pill_guest: '宾客',
      cf_pill_agent: '旅行社',
      cf_pill_instructor: '潜水教练',
      cf_name: '姓名',
      cf_name_ph: '您的全名',
      cf_email: '电子邮件',
      cf_phone: '电话',
      cf_tab_trip: '行程',
      cf_tab_meal: '餐饮',
      cf_tab_transfer: '机场接送',
      cf_tab_diving: '潜水',
      cf_trip_t: '您的行程',
      cf_trip_sub: '基本信息——抵达时间、人数以及所需房型。',
      cf_nights: '入住晚数',
      cf_nights_ph: '例如 4',
      cf_month: '计划出行月份',
      cf_checkin: '期望入住日期',
      cf_optional: '（选填）',
      cf_dates_note: '暂时无需确切日期——我们会在确认预订时与您核实。',
      cf_same: '团队中所有人的入住时长是否相同？',
      cf_yes: '是',
      cf_no: '否',
      cf_total: '团队总人数',
      cf_total_ph: '例如 6',
      ...
      cf_meal_full: '住宿 + 全餐',
      cf_meal_room: '仅住宿',
      cf_meal_hint: '全餐每人每晚加收 1,500 比索，不含在基础房价内——如您希望在外用餐，可选择仅住宿。',
      cf_transfer: '是否需要我们安排机场接送车？',
      cf_transfer_hint: '每车 14,000 比索，往返 · 最多 7 人（轻便行李）',
      cf_divers: '团队中有多少人潜水？',
      cf_divers_ph: '无人潜水请填 0',
      cf_courses: '是否有人希望在住宿期间参加课程或考取认证？',
      cf_extra_intro: '教练 / 旅行社请上传以下文件：',
      cf_credentials: '资质证明',
      cf_cred_hint_instr: '例如 PADI/SSI 教练电子证',
      cf_cred_hint_agent: '例如公司 / 营业登记',
      cf_permit: '营业许可',
      cf_agency_dive: '潜水机构',
      cf_country: '国家',
      cf_country_ph: '居住国家',
      cf_contact_person: '联系人',
      cf_contact_person_ph: '我们应联系谁',
      cf_agent_name: '代理人姓名',
      cf_agent_name_ph: '预订代理人姓名',
      cf_agency: '旅行社',
      cf_agency_ph: '旅行社 / 公司名称',
      cf_agency_addr: '机构地址',
      cf_agency_addr_ph: '机构地址',
      cf_message: '特殊要求',
      cf_message_ph: '饮食需求、庆祝活动、无障碍需求、航班时间或其他需要告知我们的事项。',
      cf_submit_bn: '提交咨询表',
      cf_error: '出了点问题，请重试或直接给我们发邮件。',
      cf_success: '谢谢！您的咨询表已发送。我们将通过电子邮件回复空房情况与报价。',
      ...
      dive_course1_desc:     '无需任何认证。通过泳池课程和浅海潜水体验水肺潜水——设备和 Divepro 服务均已包含。',
      dive_course1_detail1:  '无需任何经验',
      dive_course1_detail2:  '半天体验',
      dive_course1_detail3:  '最深12米',
      dive_course2_level:    '认证课程',
      dive_course2_name:     'PADI开放水域潜水员',
      dive_course2_desc:     '全球最受欢迎的潜水认证。完成5次限制水域练习和四次开放水域潜水，即可获得终身有效、全球认可的证书。',
      ...
      dive_course6_detail1:  '需持有救援潜水员及紧急第一反应员(EFR)认证',
      ...
      dive_pkgs_sub:         '从单次导览潜水到多日住宿潜水套餐——我们为每位潜水员和每种行程提供合适选择。',
      ...
      dive_pkg2_name:        '下午加潜',
      dive_pkg2_tagline:     '同日追加第三次潜水',
      dive_pkg2_feat1:       '含出海费用',
      dive_pkg2_feat2:       '1名潜导服务',
      dive_pkg2_feat3:       '气瓶及潜水许可',
      dive_pkg2_feat4:       '潜水简报及记录本签名',
      dive_pkg2_feat5:       '不含设备租借（可另行租借）',
  ...
  function applyTranslation(lang) {
    ...
    var SEL = {
      ...
      '.nav-links a[href="rooms.html"],.nav-links a[href="/rooms"]':                         { en:'Rooms',    zh:'客房' },
      '.nav-links a[href="dive.html"],.nav-links a[href="/dive"]':                          { en:'Dive',     zh:'潜水' },
      '.nav-links a[href="gallery.html"],.nav-links a[href="/gallery"]':                       { en:'Gallery',  zh:'图库' },
      '.nav-links a[href="location.html"],.nav-links a[href="/location"]':                      { en:'Location', zh:'位置' },
      '.nav-links a[href="blog.html"],.nav-links a[href="/blog"]':                          { en:'Blog',     zh:'博客' },
      /* Mobile nav */
      '.mob-link[href="#about"]':   { en:'About',    zh:'关于我们' },
      '.mob-link[href="rooms.html"],.mob-link[href="/rooms"]':  { en:'Rooms',    zh:'客房' },
      '.mob-link[href="dive.html"],.mob-link[href="/dive"]':   { en:'Dive',     zh:'潜水' },
      '.mob-link[href="gallery.html"],.mob-link[href="/gallery"]':{ en:'Gallery',  zh:'图库' },
      '.mob-link[href="location.html"],.mob-link[href="/location"]':{ en:'Location', zh:'位置' },
      '.mob-link[href="blog.html"],.mob-link[href="/blog"]':   { en:'Blog',     zh:'博客' },
