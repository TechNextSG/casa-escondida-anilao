...
(function () {
  ...
  const translations = {
    en: {
      ...
      rooms_lead:         'Choose from 23 ocean-side rooms designed for the diving traveler — fall asleep to the sound of waves, wake up ready to dive.',
      ...
      rooms_page_sub:     '23 ocean-side rooms designed for the diving traveler — fall asleep to the sound of waves, wake up ready to dive.',
      ...
      pol_houserules_3:   'Children 0–4 years old are free of charge',
      pol_houserules_4:   'Children 5–9 years old charged 50% of the per person rate',
      pol_houserules_5:   'Dive gear must be rinsed before entering rooms',
    ...
    zh: {
      ...
      rooms_eyebrow:      '住宿',
      rooms_heading:      '休息与充电',
      rooms_lead:         '从23间海景客房中选择您的专属空间，专为潜水旅行者设计——伴着海浪声入眠，醒来即可投身大海。',
      rm_name_1:          '标准双人间或双床间',
      rm_name_2:          '豪华双人间或双床间',
      rm_name_3:          '海景套房',
      ...
      rooms_h1:           '客房与套房',
      rooms_page_sub:     '23间海景客房专为潜水旅行者设计——伴着海浪声入眠，醒来即可投身大海。',
      ...
      pol_houserules_3:   '0–4岁儿童免费',
      pol_houserules_4:   '5–9岁儿童按每人收费的50%收取',
      pol_houserules_5:   '潜水装备须冲洗后方可带入客房',
  ...
  function applyTranslation(lang) {
    ...
    var SEL = {
      ...
      '.r-sub':             { en:'23 ocean-side rooms designed for the diving traveler — fall asleep to the sound of waves, wake up ready to dive.',
                              zh:'23间海景客房专为潜水旅行者设计——伴着海浪声入眠，醒来即可投身大海。' },
      /* Dive hero */
