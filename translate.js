...
(function () {
  ...
  const translations = {
    en: {
      ...
      rooms_lead:         'Choose from 31 ocean-side rooms designed for the diving traveler — fall asleep to the sound of waves, wake up ready to dive.',
      ...
      rooms_page_sub:     '31 ocean-side rooms designed for the diving traveler — fall asleep to the sound of waves, wake up ready to dive.',
      ...
      marquee_4:          'Free Breakfast Included',
      marquee_5:          'Island BBQ Experience',
      marquee_6:          '31 Rooms & Suites',
      ...
      rm_feat_1_1:        '18 sqm',
      rm_feat_1_2:        '2 Single Beds',
      rm_feat_1_3:        'Air Con',
      rm_feat_1_4:        'Private Bathroom',
      rm_feat_1_5:        'Free WiFi',
      rm_feat_2_1:        '40 sqm',
      rm_feat_2_2:        '2 Double Beds',
      ...
      rm_feat_3_3:        'Hot Tub',
      rm_feat_3_4:        '2 Double Beds',
      rm_view_btn:        'View Room',
      rm_book_btn:        'Book Now',
      rooms_note:         'Breakfast included for all guests · Non-smoking rooms available · Contact us for dive & stay packages →',
      ...
      modal_note:         'Or message us on Facebook · Booking.com',
      ...
      rooms_h1_text:      'Rooms',
      rooms_h1_em:        '& Suites',
      rooms_stat_1_number:'31',
      rooms_stat_1_label: 'Ocean-side Rooms',
      ...
      pol_inclusions_1:   'Full Filipino breakfast for all guests',
      ...
      pol_houserules_1:   'Non-smoking rooms — designated outdoor areas available',
      ...
      dive_course1_desc:     'No certification needed. Try scuba in a controlled pool session followed by a shallow open-water dive under direct instructor supervision.',
      ...
      dive_course2_detail1:  'Age 10+ / Non-swimmer friendly',
      ...
      dive_pkg1_feat1:       '2 guided boat dives',
      dive_pkg1_feat2:       'Tank, weights & weight belt',
      dive_pkg1_feat3:       'Divemaster guide',
      dive_pkg1_feat4:       'Dive briefing & logbook signing',
      dive_pkg1_feat5:       'Hot shower post-dive',
      ...
      dive_pkg2_feat2:       '3 dives per day (9 total)',
      dive_pkg2_feat3:       'Full equipment rental available',
      dive_pkg2_feat4:       'Nitrox fills available',
      dive_pkg2_feat5:       'Dedicated divemaster',
      dive_pkg2_feat6:       'Night dive on house reef',
      dive_pkg_cta_book:     'Book This Package',
      dive_pkg3_name:        'Night Diver Special',
      dive_pkg3_tagline:     'Witness Anilao transform after dark',
      dive_pkg3_feat1:       '1 guided night dive (house reef)',
      dive_pkg3_feat2:       'Dive torch & safety equipment',
      dive_pkg3_feat3:       'Experienced night divemaster',
    ...
    zh: {
      ...
      rooms_eyebrow:      '住宿',
      rooms_heading:      '休息与充电',
      rooms_lead:         '从31间海景客房中选择您的专属空间，专为潜水旅行者设计——伴着海浪声入眠，醒来即可投身大海。',
      rm_name_1:          '标准双人间或双床间',
      rm_name_2:          '豪华双人间或双床间',
      rm_name_3:          '海景套房',
      ...
      rooms_h1:           '客房与套房',
      rooms_page_sub:     '31间海景客房专为潜水旅行者设计——伴着海浪声入眠，醒来即可投身大海。',
      rm_card_name_1:     '标准双人间或双床间',
      rm_card_name_2:     '豪华双人间或双床间',
      rm_card_name_3:     '海景套房',
      rm_card_desc_1:     '温馨舒适，享花园景或局部海景，是独行旅客或情侣的理想之选。',
      rm_card_desc_2:     '宽敞的海景客房配备私人阳台，每天清晨伴着海景醒来。',
      rm_card_desc_3:     '我们最尊贵的房型——宽阔无垠的海景、高端配置，以及充裕的休闲空间。',
      ...
      rm_name_2:          '豪华双人间或双床间',
      rm_name_3:          '海景套房',
      rm_desc_1:          '提供免费洗漱用品，该双人/双床间设有独立卫浴，配备淋浴和智能马桶盖。房间设有空调、地砖地板和平板电视，提供2张床位。',
      rm_desc_2:          '宽敞的双人/双床间配备空调、衣柜，以及可欣赏海景的露台，独立卫浴含淋浴设施，提供2张大床。',
      rm_desc_3:          '套房设有热水浴缸，包含1间客厅、1间独立卧室及1间浴室（含浴缸）。露台可俯瞰海景与泳池景观，配有空调和平板电视，提供2张大床。',
      rm_feat_1_1:        '18平方米',
      rm_feat_1_2:        '2张单人床',
      rm_feat_1_3:        '空调',
      rm_feat_1_4:        '独立卫浴',
      ...
      rm_view_btn:        '查看客房',
      rm_book_btn:        '立即预订',
      rooms_note:         '所有住客含早餐 · 提供禁烟客房 · 联系我们了解潜水住宿套餐 →',
      ...
      modal_note:         '或通过以下渠道联系我们：Facebook · Booking.com',
      ...
      inc_frontdesk_title:'24小时前台',
      inc_frontdesk_desc: '全天候提供入住办理、潜水预订及咨询服务。',
      rooms_sec_eyebrow:  '选择您的房间',
      rooms_sec_h2:       '找到您的理想住所',
      rooms_sec_sub:      '从温馨的标准客房到宽敞的海景套房——每间客房均含早餐，步行即可抵达海边。',
      rm_badge_standard:  '标准',
      rm_badge_deluxe:    '豪华',
      rm_badge_suite:     '套房',
      ...
      pol_inclusions_1:   '所有住客享用丰盛菲律宾式早餐',
      pol_inclusions_2:   '客房及公共区域免费Wi-Fi',
      pol_inclusions_3:   '使用游泳池及度假村设施',
      pol_inclusions_4:   '潜水装备冲洗水槽及晾晒架',
      pol_houserules_title:'住宿规定',
      pol_houserules_1:   '禁烟客房——户外指定区域可吸烟',
      pol_houserules_2:   '客房内不允许携带宠物',
      pol_houserules_3:   '晚上10:00起保持安静',
      pol_houserules_4:   '潜水装备须冲洗后方可带入客房',
      ...
      dive_course1_desc:     '无需任何认证。先在有控制的泳池中体验水肺潜水，随后在教练直接监督下进行浅海开放水域潜水。',
      ...
      dive_course2_detail1:  '10岁以上 / 不会游泳亦可',
      ...
      dive_pkg1_name:        '日间潜水',
      dive_pkg1_tagline:     '适合持证宾客及日间访客',
      dive_pkg1_feat1:       '2次导览船潜',
      dive_pkg1_feat2:       '气瓶、配重及配重带',
      dive_pkg1_feat3:       '潜导陪同',
      dive_pkg1_feat4:       '潜水简报及记录本签名',
      dive_pkg1_feat5:       '潜水后热水淋浴',
      ...
      dive_pkg2_feat2:       '每天3次潜水（共9次）',
      dive_pkg2_feat3:       '可租借全套设备',
      dive_pkg2_feat4:       '可充装氮氧混合气',
      dive_pkg2_feat5:       '专属潜导',
      dive_pkg2_feat6:       '礁盘夜潜',
      dive_pkg_cta_book:     '预订此套餐',
      dive_pkg3_name:        '夜潜特别套餐',
      dive_pkg3_tagline:     '见证阿尼劳入夜后的蜕变',
      dive_pkg3_feat1:       '1次导览夜潜（礁盘）',
      dive_pkg3_feat2:       '潜水手电及安全装备',
      dive_pkg3_feat3:       '经验丰富的夜潜潜导',
      dive_pkg3_feat4:       '潜水后在CE餐厅享用晚餐',
      dive_pkg3_feat5:       '记录本签名及简报',
  ...
  function applyTranslation(lang) {
    ...
    var SEL = {
      ...
      '.r-sub':             { en:'31 ocean-side rooms designed for the diving traveler — fall asleep to the sound of waves, wake up ready to dive.',
                              zh:'31间海景客房专为潜水旅行者设计——伴着海浪声入眠，醒来即可投身大海。' },
      /* Dive hero */
